...
//        print_r($data);
    ...
    public function draw($functionName, $target_div_id, $chartVarName, $dataVarName,  $data){
        ...
        echo "document.getElementById('".$target_div_id."').id = '".$target_div_id."_".$data['info']['chart'].$data['info']['id']."';";
        echo "document.getElementById('".$target_div_id."_unit').id = '".$target_div_id."_".$data['info']['chart'].$data['info']['id']."_unit';";
        echo "document.getElementById('".$target_div_id."_info').id = '".$target_div_id."_".$data['info']['chart'].$data['info']['id']."_info';";


        $this->dataVarName = $dataVarName;
        $this->targetDivID = $target_div_id."_".$data['info']['chart'].$data['info']['id'];
        $this->chartVarName = $chartVarName;
        $this->functionName = $functionName;
...
//        print_r($data);
        ...
        $this->options($data);
        $this->drawChart($chartVarName, $this->targetDivID, $data);

        echo '}'.PHP_EOL;

        echo "document.getElementById('".$this->targetDivID."_unit').innerText = '".$data['info']['unit']."';";
        echo "document.getElementById('".$this->targetDivID."_info').innerText = '".json_encode($data['info']['info'])."';";
    }
